...
<tr><td style="background:#065f46;padding:28px;color:#ffffff;">
...
<p style="margin:12px 0 0;color:#ecfdf5;line-height:1.6;">Tu recibo de pago fue validado y tu compra quedo correcta.</p>
</td></tr>
<tr><td style="padding:24px;">
<p style="margin:0 0 12px;font-weight:800;color:#047857;text-transform:uppercase;font-size:13px;">Tickets confirmados</p>
...
<tr><td style="color:#64748b;font-size:14px;">Monto pagado</td><td align="right" style="font-size:20px;font-weight:900;">₡{{ number_format($order->amount_total, 0, ',', ' ') }}</td></tr>
<tr><td style="padding-top:10px;color:#64748b;font-size:14px;">Estado</td><td align="right" style="padding-top:10px;font-size:18px;font-weight:900;color:#047857;">Aprobado</td></tr>
</table>
