<x-layouts.app title="Pagos - Sorteos CR" section="Verificacion">
    <div class="space-y-5" data-admin-realtime-url="{{ route('admin.realtime') }}">
        <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex flex-wrap items-end justify-between gap-3">
                ...
                <span class="rounded-full bg-amber-50 px-3 py-2 text-sm font-black text-amber-700" data-admin-pending-count>{{ $pendingOrders->count() }} pendiente(s)</span>
            </div>

            <div class="mt-5 grid gap-4" data-admin-pending-list>
